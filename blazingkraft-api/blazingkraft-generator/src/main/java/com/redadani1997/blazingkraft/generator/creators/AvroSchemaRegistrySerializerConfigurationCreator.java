...
public class AvroSchemaRegistrySerializerConfigurationCreator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneratorUtils.printConfigurationFiles(
                config,
                "/home/reda/Desktop/projects/blazingkraft/blazingkraft-api/tmp/configuration/avro_schema_registry_serializer",
                "AvroSchemaRegistrySerializerConfiguration",
                "./avro_schema_registry_serializer/");
    }

    private static Map<String, CustomConfigKey> normalKeys() {
        try {
            Field configField = KafkaAvroSerializerConfig.class.getDeclaredField("config");
