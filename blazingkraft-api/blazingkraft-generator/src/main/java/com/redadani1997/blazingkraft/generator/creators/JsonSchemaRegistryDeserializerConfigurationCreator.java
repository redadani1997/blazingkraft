...
public class JsonSchemaRegistryDeserializerConfigurationCreator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneratorUtils.printConfigurationFiles(
                config,
                "/home/reda/Desktop/projects/blazingkraft/blazingkraft-api/tmp/configuration/json_schema_registry_deserializer",
                "JsonSchemaRegistryDeserializerConfiguration",
                "./json_schema_registry_deserializer/");
    }

    private static Map<String, CustomConfigKey> normalKeys() {
        try {
            Field configField = KafkaJsonSchemaDeserializerConfig.class.getDeclaredField("config");
