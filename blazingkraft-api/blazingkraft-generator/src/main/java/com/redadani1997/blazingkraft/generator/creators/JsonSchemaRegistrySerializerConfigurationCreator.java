...
public class JsonSchemaRegistrySerializerConfigurationCreator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneratorUtils.printConfigurationFiles(
                config,
                "/home/reda/Desktop/projects/blazingkraft/blazingkraft-api/tmp/configuration/json_schema_registry_serializer",
                "JsonSchemaRegistrySerializerConfiguration",
                "./json_schema_registry_serializer/");
    }

    private static Map<String, CustomConfigKey> normalKeys() {
        try {
            Field configField = KafkaJsonSchemaSerializerConfig.class.getDeclaredField("config");
