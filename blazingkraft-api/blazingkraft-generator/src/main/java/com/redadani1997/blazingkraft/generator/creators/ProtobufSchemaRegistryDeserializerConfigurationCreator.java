...
public class ProtobufSchemaRegistryDeserializerConfigurationCreator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneratorUtils.printConfigurationFiles(
                config,
                "/home/reda/Desktop/projects/blazingkraft/blazingkraft-api/tmp/configuration/protobuf_schema_registry_deserializer",
                "ProtobufSchemaRegistryDeserializerConfiguration",
                "./protobuf_schema_registry_deserializer/");
    }

    private static Map<String, CustomConfigKey> normalKeys() {
        try {
            Field configField = KafkaProtobufDeserializerConfig.class.getDeclaredField("config");
