...
public class ProtobufSchemaRegistrySerializerConfigurationCreator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GeneratorUtils.printConfigurationFiles(
                config,
                "/home/reda/Desktop/projects/blazingkraft/blazingkraft-api/tmp/configuration/protobuf_schema_registry_serializer",
                "ProtobufSchemaRegistrySerializerConfiguration",
                "./protobuf_schema_registry_serializer/");
    }

    private static Map<String, CustomConfigKey> normalKeys() {
        try {
            Field configField = KafkaProtobufSerializerConfig.class.getDeclaredField("config");
