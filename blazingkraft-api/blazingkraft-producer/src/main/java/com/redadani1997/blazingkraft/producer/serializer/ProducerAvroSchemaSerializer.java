...
public class ProducerAvroSchemaSerializer implements CommonSerializer {

    @Override
    public byte[] serialize(String topic, Headers headers, String data, String dataSchema) {
        ParsedSchema parsedSchema = CommonSchemaUtils.parseSchema(dataSchema, SchemaType.AVRO.name());
