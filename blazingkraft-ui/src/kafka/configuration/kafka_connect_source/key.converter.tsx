...
const configuration: KafkaConfiguration = {
    ...
    documentation: (
        <Text size="md">
            ...
            of the keys in messages written to or read from Kafka, and since
    ...
    documentationProps: (
        <Text className="pt-4" size="xs" color="dimmed">
            ...
            <Anchor
                size="xs"
                href={`https://docs.confluent.io/platform/current/installation/configuration/connect/source-connect-configs.html#key-converter`}
                target="_blank"
            >
                learn more here
            </Anchor>
