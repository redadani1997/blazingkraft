...
interface CommonAvroSchemaValidatorEditorProps {
    className: string;
    schema: string;
...
function CommonAvroSchemaValidatorEditor({
    className,
    schema,
    ...
    content,
    setContent,
}: CommonAvroSchemaValidatorEditorProps) {
    ...
    useEffect(() => {
        const schemaJson = AvroSchemaUtils.parseStringToJson(debouncedSchema);
        const contentJson = AvroSchemaUtils.parseStringToJson(debouncedContent);
...
CommonAvroSchemaValidatorEditor.defaultProps = {
    className: '',
    isSchemaRegistryValidation: true,
    schemaReferences: [],
};

export default CommonAvroSchemaValidatorEditor;
