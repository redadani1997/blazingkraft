...
interface EditConnectorValidationPreviewComponent {
...
function EditConnectorValidationPreviewComponent({
    serverErrorMessage,
    connectPluginValidationResponse,
    setHasConfigurationError,
    setActiveTab,
}: EditConnectorValidationPreviewComponent) {
...
export default EditConnectorValidationPreviewComponent;
