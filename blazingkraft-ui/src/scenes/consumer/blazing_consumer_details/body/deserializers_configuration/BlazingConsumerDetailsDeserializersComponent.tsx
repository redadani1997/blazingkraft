...
import BlazingConsumerDetailsDeserializerConfiguration from './BlazingConsumerDetailsDeserializerConfiguration';

interface BlazingConsumerDetailsDeserializersComponentProps {
...
function BlazingConsumerDetailsDeserializersComponent({
    keyDeserializer,
    valueDeserializer,
    ...
    setValueDeserializerConfiguration,
    consumerCompleteConfiguration,
}: BlazingConsumerDetailsDeserializersComponentProps) {
    ...
    if (ConsumerUtils.isSchemaRegistryDeserializer(keyDeserializer)) {
        items.push({
            ...
            label: 'Key Props',
            children: (
                <BlazingConsumerDetailsDeserializerConfiguration
...
export default BlazingConsumerDetailsDeserializersComponent;
