...
import HomeManagementLinkComponent from './HomeManagementLinkComponent';

const HomeManagementLink = () => {
    // Map State To Props
...
export default HomeManagementLink;
