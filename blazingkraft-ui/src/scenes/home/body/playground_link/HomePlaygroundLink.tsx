...
import HomePlaygroundLinkComponent from './HomePlaygroundLinkComponent';

const HomePlaygroundLink = () => {
    // Map State To Props
...
export default HomePlaygroundLink;
