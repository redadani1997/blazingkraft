...
interface CreateKafkaConnectBodyComponentProps {
...
const CreateKafkaConnectBodyComponent = ({
    clusters,
    testKafkaConnectClientConnectivity,
    createKafkaConnect,
...
}: CreateKafkaConnectBodyComponentProps) => {
    ...
    const [kafkaConnectClusterCode, setKafkaConnectClusterCode] =
        useState(null);
    const [kafkaConnectUrl, setKafkaConnectUrl] = useState(
...
export default CreateKafkaConnectBodyComponent;
