...
interface DeleteKsqlDbComponentProps {
    isModalOpen: boolean;
    setIsModalOpen: Function;
    deleteKsqlDb: () => Promise<any>;
    ...
    return (
        <>
            <Alert
                ...
                color="lime"
            >
                <Text>Please confirm KsqlDb Deletion.</Text>
            </Alert>
        </>
    );
}
...
function DeleteKsqlDbComponent({
    setIsModalOpen,
    isModalOpen,
    isDeleteKsqlDbPending,
    ksqlDbToDelete,
    deleteKsqlDb,
}: DeleteKsqlDbComponentProps) {
    const action = () => deleteKsqlDb();
        ...
        <CommonModal
            ...
            modalTitle={
                <div className="flex items-center break-all">
                    <Text className="pr-2">Delete KsqlDb</Text>
            ...
            isLoading={isDeleteKsqlDbPending}
        />
    );
}

export default DeleteKsqlDbComponent;
