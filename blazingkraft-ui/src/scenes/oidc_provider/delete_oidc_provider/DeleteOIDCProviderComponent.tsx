...
interface DeleteOIDCProviderComponentProps {
    isModalOpen: boolean;
    setIsModalOpen: Function;
    deleteOIDCProvider: () => Promise<any>;
    ...
    return (
        <>
            <Alert
                ...
                color="lime"
            >
                <Text>Please confirm OpenID Connect provider Deletion.</Text>
            </Alert>
        </>
    );
}
...
function DeleteOIDCProviderComponent({
    setIsModalOpen,
    isModalOpen,
    isDeleteOIDCProviderPending,
    OIDCProviderName,
    deleteOIDCProvider,
}: DeleteOIDCProviderComponentProps) {
    const action = () => deleteOIDCProvider();
        ...
        <CommonModal
            ...
            modalTitle={
                <div className="flex items-center break-all">
                    <Text className="pr-2">Delete OIDC Provider</Text>
            ...
            isLoading={isDeleteOIDCProviderPending}
        />
    );
}

export default DeleteOIDCProviderComponent;
