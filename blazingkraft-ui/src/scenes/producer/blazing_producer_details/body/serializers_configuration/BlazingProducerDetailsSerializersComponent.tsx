...
import BlazingProducerDetailsSerializersConfiguration from './BlazingProducerDetailsSerializersConfiguration';

interface BlazingProducerDetailsSerializersComponentProps {
...
function BlazingProducerDetailsSerializersComponent({
    keySerializer,
    valueSerializer,
    ...
    setValueSerializerConfiguration,
    producerCompleteConfiguration,
}: BlazingProducerDetailsSerializersComponentProps) {
    ...
    if (ProducerUtils.isSchemaRegistrySerializer(keySerializer)) {
        items.push({
            ...
            label: 'Key Props',
            children: (
                <BlazingProducerDetailsSerializersConfiguration
...
export default BlazingProducerDetailsSerializersComponent;
