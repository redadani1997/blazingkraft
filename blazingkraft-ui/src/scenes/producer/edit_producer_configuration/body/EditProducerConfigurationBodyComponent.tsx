...
import EditProducerSerializers from './serializers_configuration/EditProducerSerializers';

interface EditProducerConfigurationBodyComponentProps {
    editProducerConfiguration: any;
...
const EditProducerConfigurationBodyComponent = ({
    editProducerConfiguration,
    producerCompleteConfiguration,
    isGetProducerCompleteConfigurationPending,
}: EditProducerConfigurationBodyComponentProps) => {
    ...
    const items = [
        {
            ...
            children: (
                <ConfigurationsTabs
                    ...
                    configurations={ProducerConfiguration.configurations}
...
export default EditProducerConfigurationBodyComponent;
